...
class InfoBot(AbstractInfoBot):
    def show_all(book):
        return "\n".join([str(record) for record in book.data.values()])

    def show_all_command(self):
        return ["hello","add","change","phone","all","add-birthday","show-birthday","birthdays"]
...
def main():
    ...
    while True:
        ...
        if command in ["close", "exit"]:
            ...
            print(InfoBot.show_all_command())
